...
<?php echo "<$block class='blog-title'>"; ?>
	<a href="<?php echo home_url(); ?>/" accesskey="1"><?php bloginfo('name'); ?></a>
<?php echo "</$block>"; ?>
...
<ul class="menu">
	<li class="<?php if ( is_front_page() && !is_paged() ): ?>current_page_item<?php else: ?>page_item<?php endif; ?> blogtab">
		<a href="<?php echo home_url(); ?>/" title="<?php echo esc_attr( get_option('unwakeable_blogornoblog') ); ?>">
			<?php echo get_option('unwakeable_blogornoblog'); ?>
		</a>
	</li>
