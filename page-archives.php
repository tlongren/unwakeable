		...
		<div id="current-content" class="hfeed">
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-content">
					...
					<h3><?php _e('Browse by Category','unwakeable_domain'); ?></h3>
					<ul class="archive-list">
				...
				<div class="entry-foot">
					<?php wp_link_pages( array('before' => '<div class="entry-pages"><span>' . __('Pages:','unwakeable_domain') . '</span>', 'after' => '</div>' ) ); ?>
